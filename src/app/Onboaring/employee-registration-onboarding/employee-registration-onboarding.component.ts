...
//Add user form actions
  ...
  get employee_type() { return this.registerForm.get('employee_type'); }
  get marital_status() { return this.registerForm.get('marital_status'); }
...
//  this.getcompanyMainlingInfo();
  ...
  this.authService.onboarding_registeration(this.registerForm.value).subscribe(async (result:any) => {
...
// // this.authService.updateEmployee(this.registerForm.value.personal_email_id,empID).subscribe(async (result:any) => {
// //       console.log(result);
// //       console.log (result.message)
// //     })
