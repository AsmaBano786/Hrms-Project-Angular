...
console.log();
  ...
  UpdateTimesheetPendingReport(employeeId: any, TimeSheetId: any,Action:any): Observable<any> {
    console.log("api",employeeId);
    console.log("api data..........................",TimeSheetId);
    console.log(`${this.apiUrl}/api/v1/timesheet/ApprovalRequest/`+employeeId+'/'+TimeSheetId,Action);
    
    return this.httpClient.put(`${this.apiUrl}/api/v1/timesheet/ApprovalRequest/`+employeeId+'/'+TimeSheetId,Action);
