...
@Component({
  selector: 'app-employee-update-timesheet',
  templateUrl: './employee-update-timesheet.component.html',
  styleUrls: ['./employee-update-timesheet.component.css']
})
export class EmployeeUpdateTimesheetComponent implements OnInit {
...
console.log(data.length,this.departId);
