...
@Component({
  selector: 'app-edit-apply-leave-onboarding',
  templateUrl: './edit-apply-leave-onboarding.component.html',
  styleUrls: ['./edit-apply-leave-onboarding.component.css']
})
export class EditApplyLeaveOnboardingComponent implements OnInit {
  submitted: any;
  date_from: any;
